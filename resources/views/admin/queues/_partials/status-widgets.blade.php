<div class="row">
	...
	<div class="col-lg-4 col-md-4 mb-4">
		<div class="card"
		     :class="{ 'bgc-green': stats.status == 'running', 'bgc-blue': stats.status == 'paused', 'bgc-gray-dark' :stats.status == 'inactive', 'bgc-red' : stats.status == 'error' }">
			<div class="card-body">
				...
				<div class="" v-if="! loadingStats && !redisConnected">
					<span class="stat-value fsz-md ls-12 tt-u c-white">
                        Error
                    </span>
				</div>
